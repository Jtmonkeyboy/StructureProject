...
bool Music :: operator > (const Music & compared)
{
    bool isThisMore = (this->artist_hotttnesss > compared.getArtist_hotttnesss()) && (this->song_hotttnesss > compared.song_hotttnesss);return isThisMore;
}

bool Music :: operator == (const Music & compared){bool isThisTheSame = (this->artist_id == compared.artist_id) && (this->title == compared.title);
...
double Music :: getBeats_confidence() const
{
    return  beats_confidence;
}

double Music :: getBeats_start() const
{
    return  beats_start;
}
...
double Music :: getEnd_of_fade_in() const
{
    return  end_of_fade_in;
}

double Music :: getFamiliarity() const
{
    return  familiarity;
}

int Music :: getKey() const
{
    return  key;
}

double Music :: getKey_confidence() const
{
    return  key_confidence;
}

double Music :: getLatitude() const
{
    return  latitude;
}

string Music :: getLocation() const
{
    return  location;
}

double Music :: getLongitude() const
{
    return  longitude;
}

double Music :: getLoudness() const
{
    return  loudness;
}

int Music :: getMode() const
{
    return  mode;
}

double Music :: getMode_confidence() const
{
    return  mode_confidence;
}

int Music :: getRelease_id() const
{
    return  release_id;
}

string Music :: getRelease_name() const
{
    return  release_name;
}

string Music :: getSimilar() const
{
    return  similar;
}

double Music :: getSong_hotttnesss() const
{
    return  song_hotttnesss;
}

string Music :: getSong_id() const
{
    return  song_id;
}

double Music :: getStart_of_fade_out() const
{
    return  start_of_fade_out;
}

double Music :: getTatums_confidence() const
{
    return  tatums_confidence;
}

double Music :: getTatums_start() const
{
    return  tatums_start;
}
...
string Music :: getTerms() const
{
    return  terms;
}

double Music :: getTerms_freq() const
{
    return  terms_freq;
}

int Music :: getTime_signature() const
{
    return  time_signature;
}

double Music :: getTime_signature_confidence() const
{
